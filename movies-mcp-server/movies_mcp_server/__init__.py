...
if not TMDB_API_KEY:
    logger.warning("TMDB_API_KEY not set. API requests may fail. Please set the TMDB_API_KEY environment variable.")
...
async def make_tmdb_request(url: str, params: Dict[str, Any] = None) -> Dict[str, Any] | None:
    ...
    """
    if not TMDB_API_KEY:
        logger.error("TMDB_API_KEY not configured. Please set the TMDB_API_KEY environment variable.")
        return None
